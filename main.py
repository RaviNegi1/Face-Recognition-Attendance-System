...
class Face_Recognition_System:
    def __init__(self,root):
        ...
        b1_1 = Button(bg_img, text="Face Detector", cursor="hand2", font = ("arial", 12, "bold"), bg = "grey", fg = "white")
        ...
        b1_1 = Button(bg_img, text="Attendance", cursor="hand2", font = ("arial", 12, "bold"), bg = "grey", fg = "white")
        ...
        b1_1 = Button(bg_img, text="Train Data", cursor="hand2", font = ("arial", 12, "bold"), bg = "grey", fg = "white")
        ...
        b1_1 = Button(bg_img, text="Developer", cursor="hand2", font = ("arial", 12, "bold"), bg = "grey", fg = "white")
